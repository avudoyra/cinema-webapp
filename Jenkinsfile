 ...
 stage("Crear cluster en ECS"){
      steps {
          script {
            ...
            aws ecs create-service --cluster fargate-cluster --service-name fargate-service --task-definition new-fargate-app:1 --desired-count 1 --launch-type "FARGATE" --network-configuration "awsvpcConfiguration={subnets=[	subnet-02788912cab17b0ab],securityGroups=[sg-0b04d4c180e08a75f],assignPublicIp=ENABLED}"
